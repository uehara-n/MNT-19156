			...
			<nav class="navbar-default">
				...
				<div class="collapse navbar-collapse" id="defaultNavbar1">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown bar"><a href="<?php bloginfo('url'); ?>/seko" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">施工事例</a>
						<ul class="dropdown-menu">
